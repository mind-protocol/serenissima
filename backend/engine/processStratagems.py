...
from backend.engine.stratagem_processors.express_creative_will_stratagem_processor import process as process_express_creative_will_stratagem
...
STRATAGEM_PROCESSORS = {
    ...
    "express_creative_will": process_express_creative_will_stratagem,
