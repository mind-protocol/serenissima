...
from .prepare_sermon_processor import process_prepare_sermon # New processor for preparing sermons
...
from .lead_meditation_processor import process_lead_meditation
from .join_meditation_processor import process_join_meditation
from .express_creative_will_processor import process as process_express_creative_will

# Import new social class processors
from .shepherd_consciousness_processor import process_shepherd_consciousness
from .cascade_development_processor import process_cascade_development
from .cascade_sales_processor import process_cascade_sales
from .administrative_duties_processor import process_administrative_duties
...
ACTIVITY_PROCESSORS = {
    ...
    # Group meditation activities
    'lead_meditation': process_lead_meditation,
    'join_meditation': process_join_meditation,
    'read_at_library': process_read_at_library_fn,
    'express_creative_will': process_express_creative_will,
    # New social class activities
    'shepherd_consciousness': process_shepherd_consciousness,
    'cascade_development': process_cascade_development,
    'cascade_sales': process_cascade_sales,
    'administrative_duties': process_administrative_duties,
}
