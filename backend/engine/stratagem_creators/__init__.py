...
from .express_creative_will_stratagem_creator import try_create as try_create_express_creative_will_stratagem
...
STRATAGEM_CREATORS = {
    ...
    "express_creative_will": try_create_express_creative_will_stratagem,
