...
from backend.engine.handlers.special import (
    ...
    _handle_clero_shepherd_consciousness,
    _handle_arsenalotti_cascade_development,
    _handle_mercanti_cascade_sales,
    _handle_amministratori_duties
)
...
class CitizenActivityOrchestrator:
    ...
    def __init__(self):
        ...
        self.work_handlers: List[Tuple[int, HandlerFunc, str]] = [
            ...
            (26, _handle_clero_shepherd_consciousness, "Clero Shepherd Consciousness"),
            ...
            (31, _handle_arsenalotti_cascade_development, "Arsenalotti CASCADE Development"),
            (31, _handle_mercanti_cascade_sales, "Mercanti CASCADE Sales"),
            (31, _handle_amministratori_duties, "Amministratori Administrative Duties"),
