        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li><a href="#data-access" className="text-amber-700 hover:underline">Data Access</a>
            <ul className="list-circle pl-6 space-y-1 mt-1">
              ...
              <li><a href="#data-access-get-building-ledger" className="text-amber-600 hover:underline text-sm">GET /api/get-building-ledger</a></li>
            </ul>
          </li>
  ...
  "data": {
    ...
    "counts": {
      ...
      "activeBuyingContracts": number
        ...
        <div id="data-access-get-building-ledger" className="mb-8 scroll-mt-20">
          <h3 className="text-2xl font-serif text-amber-700 mb-2">GET /api/get-building-ledger</h3>
          <p className="mb-2">Retrieves comprehensive information about a specific building, including its type details, citizens present, recent messages, and resources stored at the location.</p>
          <div className="bg-white p-4 rounded-lg shadow mb-4">
            <h4 className="font-bold mb-2">Query Parameters</h4>
            <ul className="list-disc pl-6">
              <li><code>buildingId</code> (required) - The ID of the building (e.g., "building_automated_mill").</li>
              <li><code>format</code> (optional) - Response format: "json" or "markdown" (default).</li>
            </ul>
          </div>
          <div className="bg-white p-4 rounded-lg shadow mb-4">
            <h4 className="font-bold mb-2">Response (JSON Format)</h4>
            <pre className="bg-gray-100 p-3 rounded overflow-x-auto text-sm">
{`{
  "building": {
    "id": "string",
    ...
    "name": "string",
    "owner": "string",
    "position": { "lat": number, "lng": number } | string,
    "status": "string",
    "description": "string",
    "createdAt": "string"
  },
  ...
  "resources": [
    {
      ...
      "owner": "string"
          ...
          <div className="bg-white p-4 rounded-lg shadow mb-4">
            <h4 className="font-bold mb-2">Response (Markdown Format)</h4>
            <p className="mb-2">Returns a formatted markdown document with:</p>
            <ul className="list-disc pl-6 text-sm">
              <li>Basic building information (ID, type, owner, position, status)</li>
              <li>Building type details (category, price, occupancy, maintenance cost, functions)</li>
              <li>List of citizens currently present in the building</li>
              <li>Last 10 messages sent to the building</li>
              <li>Resources stored at the building location</li>
              <li>Reference list of all building types in Venice</li>
            </ul>
          </div>
          <div className="bg-white p-4 rounded-lg shadow mb-4">
            <h4 className="font-bold mb-2">Example Usage</h4>
            <pre className="bg-gray-100 p-3 rounded overflow-x-auto text-sm">
{`// Get building ledger in markdown format
GET /api/get-building-ledger?buildingId=building_automated_mill

// Get building ledger in JSON format
GET /api/get-building-ledger?buildingId=building_bakery_123&format=json`}
            </pre>
          </div>
        </div>
      </section>
