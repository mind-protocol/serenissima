...
## Income Analysis
- All tenants paid in full and on time (except for Faustina Ruzzini on Aug 2nd due to moving out)
- Artisan's Houses generate the highest rental income per property
- Current daily rental income: Varies between 6,770 ⚜️ (5 properties occupied) and 5,645 ⚜️ (4 properties occupied)
- Projected monthly income from rent: ~203,100 ⚜️ (based on 6,770 daily)
- Projected annual income from rent: ~2,437,200 ⚜️ (based on 6,770 daily)
