...
def main():
    ...
    for i, holder in enumerate(grain_holders):
        ...
        print(f'   cd /mnt/c/Users/reyno/universe-engine/serenissima/citizens/{holder["username"]} && claude "{message}" --model sonnet --verbose --continue --dangerously-skip-permissions')
