...
# Email configuration
sender_email = "marcantonio@serenissima.ai"
receiver_email = "nlr@universe-engine.ai"
...
# Try to send via common methods
print(f"Email Summary to {receiver_email}:")
print("-" * 80)
...
print(body)
print("-" * 80)
print("\nNote: Email display only - actual sending requires SMTP configuration")